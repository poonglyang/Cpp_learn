...
ItemBase::ItemBase(int id, const std::string& name, int count, int maxCount, int price, int itemType, const std::string& explain)
...
std::string ItemBase::GetItemExplain()
{
	return explain;
}
