...
public:
	...
	Item_Equipable(
		int id, const std::string& name, int price, int itemType, const std::string& explain, int equipSlot,
...
public:
	/// <summary>
	/// 아이템 스탯을 std::vector 형태로 반환하는 함수
	/// </summary>
	/// <returns>아이템 스텟이 들어있는 std::vector</returns>
	std::vector<float> GetItemState();
